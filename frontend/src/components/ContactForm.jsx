...
//     try {
//       const res = await fetch("https://humancareairainambulance.com/contact.php", {
//         method: "POST",
...
const ContactForm = () => {
  ...
  const handleContactSubmit = async (e) => {
    ...
    try {
      // ✅ Corrected backend URL (removed extra "in" in domain)
      const res = await fetch("https://humancareairambulance.com/Contact.php", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(formData),
      });
